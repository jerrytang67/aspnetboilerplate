...
public class AbpOpenIddictScopeStore : AbpOpenIddictStoreBase<IOpenIddictScopeRepository>,
    IOpenIddictScopeStore<OpenIddictScopeModel>
{
    ...
    {
        return await Repository.GetCountAsync(string.Empty, cancellationToken);
    }

    public virtual ValueTask<long> CountAsync<TResult>(
        Func<IQueryable<OpenIddictScopeModel>, IQueryable<TResult>> query, CancellationToken cancellationToken)
    {
    ...
    public virtual async ValueTask DeleteAsync(OpenIddictScopeModel scope, CancellationToken cancellationToken)
    {
        ...
        try
        {
            await Repository.DeleteAsync(scope.Id);
        }
    ...
    public virtual async ValueTask<OpenIddictScopeModel> FindByIdAsync(string identifier,
    ...
    public virtual async ValueTask<OpenIddictScopeModel> FindByNameAsync(string name,
        CancellationToken cancellationToken)
    {
    ...
    public virtual async IAsyncEnumerable<OpenIddictScopeModel> FindByNamesAsync(ImmutableArray<string> names,
    ...
    public virtual async IAsyncEnumerable<OpenIddictScopeModel> FindByResourceAsync(string resource,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
    ...
    public virtual ValueTask<TResult> GetAsync<TState, TResult>(
        Func<IQueryable<OpenIddictScopeModel>, TState, IQueryable<TResult>> query, TState state,
        CancellationToken cancellationToken)
    {
        throw new NotSupportedException();
    }

    public virtual ValueTask<string> GetDescriptionAsync(OpenIddictScopeModel scope,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask<ImmutableDictionary<CultureInfo, string>> GetDescriptionsAsync(
        OpenIddictScopeModel scope, CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask<string> GetDisplayNameAsync(OpenIddictScopeModel scope,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask<ImmutableArray<string>> GetResourcesAsync(OpenIddictScopeModel scope,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual async IAsyncEnumerable<OpenIddictScopeModel> ListAsync(int? count, int? offset,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
    ...
    public virtual ValueTask SetDescriptionAsync(OpenIddictScopeModel scope, string description,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask SetDescriptionsAsync(OpenIddictScopeModel scope,
    ...
    public virtual ValueTask SetDisplayNameAsync(OpenIddictScopeModel scope, string name,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask SetDisplayNamesAsync(OpenIddictScopeModel scope,
    ...
    public virtual ValueTask SetNameAsync(OpenIddictScopeModel scope, string name,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual ValueTask SetPropertiesAsync(OpenIddictScopeModel scope,
    ...
    public virtual ValueTask SetResourcesAsync(OpenIddictScopeModel scope, ImmutableArray<string> resources,
        CancellationToken cancellationToken)
    {
        Check.NotNull(scope, nameof(scope));
    ...
    public virtual async ValueTask UpdateAsync(OpenIddictScopeModel scope, CancellationToken cancellationToken)
    {
        ...
        var entity = await Repository.GetAsync(scope.Id);

        try
        {
            await Repository.UpdateAsync(scope.ToEntity(entity));
        }
        catch (AbpDbConcurrencyException e)
        {
            Logger.LogError(e, e.Message);
        ...
        scope = (await Repository.FindByIdAsync(entity.Id, cancellationToken)).ToModel();
    }
}