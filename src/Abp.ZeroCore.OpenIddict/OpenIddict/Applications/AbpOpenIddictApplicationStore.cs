    ...
    IAbpOpenIdApplicationStore
{
    ...
    public virtual async ValueTask<long> CountAsync(CancellationToken cancellationToken)
    {
        return await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            await Repository.GetCountAsync(null, cancellationToken)
        );
    }
    ...
    public virtual async ValueTask DeleteAsync(OpenIddictApplicationModel application, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                await TokenRepository.DeleteManyByApplicationIdAsync(application.Id,
                    cancellationToken: cancellationToken);
    ...
    public virtual async ValueTask<OpenIddictApplicationModel> FindByIdAsync(string identifier,
        CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(identifier, nameof(identifier));

        return await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            (await Repository.FindByClientIdAsync(identifier, cancellationToken)).ToModel()
        );
    }

    public virtual async ValueTask<OpenIddictApplicationModel> FindByClientIdAsync(string identifier,
        CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(identifier, nameof(identifier));
    ...
    public virtual async IAsyncEnumerable<OpenIddictApplicationModel> FindByPostLogoutRedirectUriAsync(string uris,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(uris, nameof(uris));

        var applications = await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            await Repository.FindByPostLogoutRedirectUriAsync(uris, cancellationToken)
        );
    ...
    public virtual async IAsyncEnumerable<OpenIddictApplicationModel> FindByRedirectUriAsync(string uri,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        Check.NotNullOrEmpty(uri, nameof(uri));

        var applications = await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            await Repository.FindByRedirectUriAsync(uri, cancellationToken)
        );
    ...
    public virtual ValueTask<string> GetClientIdAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<string> GetClientSecretAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<string> GetClientTypeAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<string> GetConsentTypeAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<string> GetDisplayNameAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<ImmutableArray<string>> GetPermissionsAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<ImmutableArray<string>> GetPostLogoutRedirectUrisAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<ImmutableArray<string>> GetRedirectUrisAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual ValueTask<ImmutableArray<string>> GetRequirementsAsync(OpenIddictApplicationModel application,
        CancellationToken cancellationToken)
    {
        Check.NotNull(application, nameof(application));
    ...
    public virtual async IAsyncEnumerable<OpenIddictApplicationModel> ListAsync(int? count, int? offset,
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        var applications = await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            await Repository.ListAsync(count, offset, cancellationToken)
        );
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entity = await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            await Repository.GetAsync(application.Id)
        );
        ...
        try
        {
            await UnitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                await Repository.UpdateAsync(application.ToEntity(entity));
            });
        }
        catch (AbpDbConcurrencyException e)
        {
        ...
        {
            application =
                (await Repository.FindByClientIdAsync(entity.Id.ToString(), cancellationToken: cancellationToken))
                .ToModel();
        });
    }
