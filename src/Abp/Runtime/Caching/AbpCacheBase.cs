...
namespace Abp.Runtime.Caching {
    ...
    public abstract class AbpCacheBase<TKey, TValue> : AbpCacheBase, IAbpCache<TKey, TValue>, ICacheOptions {
        private readonly ILogger<AbpCacheBase> _logger;
        ...
        protected AbpCacheBase(string name, IIocManager iocManager) : base(name) {
            _logger = iocManager.Resolve<ILoggerFactory>().CreateLogger<AbpCacheBase>();
